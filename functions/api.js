...
app.get('/catalog', async (req, res) => {
  try {
    const catalogDir = path.join(__dirname, '../dist/images/catalog');
...
app.get('/category', async (req, res) => {
  ...
  const folderPath = path.join(__dirname, '../dist/images/catalog', category);
  let images = [];
...
app.get('/api/catalog-images', async (req, res) => {
  try {
    const catalogPath = path.join(__dirname, '../dist/images/catalog');
